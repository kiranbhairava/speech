...
# client = Groq(api_key="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")  # Replace with your actual API key
...
# def evaluate_with_groq(text):
#     """Get evaluation from Groq API"""
#     system_prompt = """You are an English language expert. Evaluate the user's speech considering {reading_text} for:
#     1. Pronunciation/clarity
#     2. Grammar accuracy
#     3. Vocabulary range
#     4. Fluency/pace
#     5. Overall coherence
#     Provide detailed feedback and a score from 1-10."""
...
# def main():
#     st.title("English Speaking Evaluation Test")
    
#     # Speaking Test Section
#     st.header("Speaking Test")
#     st.write("Record yourself speaking about the following topic:")
#     st.write("Topic: Describe your favorite holiday destination and why you like it")
    
#     # Audio recorder with streamlit component
...
#             evaluation = evaluate_with_groq(transcription)
...
#     opportunities and enhance human capabilities."""
    
#     st.write("Read the following text aloud:")
#     st.write(reading_text)
    
#     reading_audio = audio_recorder(pause_threshold=10)
    
#     if reading_audio:
#         with open("reading.wav", "wb") as f:
#             f.write(reading_audio)
        
#         # Transcribe and evaluate
#         reading_transcription = transcribe_audio("reading.wav")
#         st.subheader("Your Reading:")
#         st.write(reading_transcription)
        
#         # Evaluate reading accuracy
#         with st.spinner("Evaluating reading..."):
#             accuracy_prompt = f"Original: {reading_text}\n\nReading: {reading_transcription}\n\nEvaluate reading accuracy and fluency."
#             reading_evaluation = evaluate_with_groq(accuracy_prompt)
#             st.markdown(f"```{reading_evaluation}```")
